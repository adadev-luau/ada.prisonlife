--[[
  ...
  modified by MicrosoftsLaw for ada.prisonlife
]]
...
function library:Watermark(text)
    ...
    bar.BackgroundColor3 = Color3.fromRGB(128, 215, 255)
...
function library:Introduction()
    ...
    xsxLogo.ImageColor3 = Color3.fromRGB(128, 215, 255)
    ...
    hashLogo.ImageColor3 = Color3.fromRGB(128, 215, 255)
...
function library:Init(key)
    ...
    function TabLibrary:NewTab(title)
        ...
        page.ScrollBarImageColor3 = Color3.fromRGB(128, 215, 255)
        page.Visible = false
        ...
        if TabLibrary.IsFirst then
            page.Visible = true
            tabButton.TextColor3 = Color3.fromRGB(128, 215, 255)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(tabButton, TweenTable["tab_text_colour"], {TextColor3 = Color3.fromRGB(128, 215, 255)}):Play()
        end)
        ...
        function Components:NewButton(text, callback)
            ...
            button.MouseButton1Down:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(128, 215, 255)}):Play()
            end)
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleDesignGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(128, 215, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(180,235,255))}
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textBoxValues.Focused:Connect(function()
                    textBoxValues:GetPropertyChangedSignal("Text"):Connect(ResizeTextBox)
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Color3.fromRGB(128, 215, 255)}):Play()
                end)
    ...
    selectorFrame.Position = UDim2.new(0.005, 0, 0.089, 0)
    ...
    selector.Position = UDim2.new(0, 0, 0.092, 0)
    ...
    selectorTwo.Position = UDim2.new(0.0025, 0, 0, 0)
    ...
    local function toggleOption(btn)
        local txt = btn.Text
        local index = table.find(selectedOptions, txt)

        if index then
            table.remove(selectedOptions, index)
            TweenService:Create(btn, TweenTable["selector"], {TextColor3 = Color3.fromRGB(160, 160, 160)}):Play()
        else
            table.insert(selectedOptions, txt)
            TweenService:Create(btn, TweenTable["selector"], {TextColor3 = Color3.fromRGB(128, 215, 255)}):Play()
        end
    ...
    local function singleSelect(btn)
        ...
        TweenService:Create(btn, TweenTable["selector"], {TextColor3 = Color3.fromRGB(128, 215, 255)}):Play()
        selectorText.Text = btn.Text
        callback(btn.Text)
    end

    local function createOption(txt)
    ...
    return {}
            ...
            function SelectorFunctions:AddOption(new, callback_f)
                ...
                if optionButton.Text == default then
                    optionButton.TextColor3 = Color3.fromRGB(128, 215, 255)
        ...
        function Components:NewSlider(text, suffix, compare, compareSign, values, callback)
            ...
            sliderIndicatorGradient.Color = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(128, 215, 255)), ColorSequenceKeypoint.new(1, Color3.fromRGB(180,235,255))})
